...
const projects = [
  ...
  },
  {
    ...
    description: "A one-page e-commerce website built with pure HTML and CSS during my early learning stage. Features a product showcase, simple navigation, and responsive layout practice.",
  ...
  },
  {
    ...
    category: "python",
    title: "Zeppelin Cafe",
    description: "A modern Python desktop application for coffee shop management. Features product catalog, cart & checkout, user registration/authentication backed by SQLite, inventory & price checks, and a polished GUI for daily operations.",
  ...
  },
  {
    ...
    description: "End-to-end design for a mobile fashion shopping app from sign-up to secure checkout. Crafted in Figma and Photoshop, the project highlights intuitive flows, clean aesthetics, and a seamless user experience.",
  ...
  },
  {
    ...
    description: "UI/UX design for a personal finance learning app — from onboarding to interactive courses and expert consultations. Designed with Figma to deliver clarity, confidence, and engaging financial education.",
  ...
  },
  {
    ...
    description: "Mobile UI/UX design for a clinic management app — from patient registration to appointment scheduling and record management. Designed in Figma for clarity, efficiency, and a professional healthcare experience.",
                            ...
                            <div className="flex flex-col xl:flex-row xl:gap-12">
                              ...
                              <div className="w-full max-w-[380px] flex flex-col gap-6 xl:gap-8 xl:pt-6 order-2 xl:order-none">
                                ...
                                <div className="flex flex-col justify-between flex-1">
                                  ...
                                  {/* btns */}
                                  <div className="flex flex-col sm:flex-row gap-4 items-stretch pb-20 md:pb-0 w-full">
                                    {project.link && (
