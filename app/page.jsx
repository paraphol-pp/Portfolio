      ...
      <div className="flex flex-col xl:flex-row items-center justify-between w-full">
        ...
        <div className="w-full xl:w-[550px] flex flex-col items-center justify-center xl:items-start text-center xl:text-left">
          ...
          <p className="max-w-[500px] mb-[44px]">
            I’m a Computer Science student specializing in Frontend Development. Skilled in React, Next.js, Tailwind, and UI/UX design, I enjoy crafting clean, modern interfaces that put user experience first. I’m eager to grow through real world projects and bring fresh ideas to every team I join.
          </p>
          <Link href="/contact">
          ...
          <Socials
            ...
            iconStyles="bg-accent text-while hover:bg-accent-hover transition w-[48px] h-[48px] text-[22px] flex items-center justify-center rounded-full cursor-pointer"
          />
        </div>
